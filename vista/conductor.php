...
<head>
	...
	<?php 
		include_once("../controlador/controladorConductor.php");
		$controlConductor = new controladorConductor(); 
	?>
</head>
<body>
	<div>
		<form method="post" action="../controlador/controladorConductor.php">
			<div>				
		...
		<div>
			<table>
				...
				<tbody>
					<?php
						foreach ($controlConductor->listarConductor() as $key => $value) {
							echo "
							<tr>
								<td>".$value['cedula']."</td>
